...
from pyttsx.six import byte2int, text_type
...
MOSE_WITH_UMLAUT_HEX = u"6DC3B67365"
...
class TestUtilities(unittest.TestCase):
    ...
    def testToUtf8(self):
        ...
        self.assertEquals(5, len(utfBytes))
        self.assertEquals(LOWER_CASE_O_WITH_UMLAUT_UTF_8_1, byte2int(utfBytes[1]))
        self.assertEquals(LOWER_CASE_O_WITH_UMLAUT_UTF_8_2, byte2int(utfBytes[2]))
    
    def testFromUtf8(self):
        utfBytes = text_type(MOSE_WITH_UMLAUT_HEX).decode("hex")
        utfString = fromUtf8(utfBytes)
